...
db.AdminLog = require('./adminLog')(sequelize, DataTypes);
...
// Audit: AdminLog belongs to user
db.AdminLog && db.AdminLog.belongsTo && db.AdminLog.belongsTo(db.User, { foreignKey: 'userId' });
